...
typedef NodoLista* PtrNodoLista;        //Este se puede usar directamente para definir la lista


/* Tipo de Estructura de la Lista */

/* Este en el programa lo tengo que crear en stack*/
struct Lista {
...
/*
  ...
  lista : lista sobre la cual se invoca la primitiva. (parámetro que recibe)
*/
...
//En realidad esta no debería ser una primitiva de una lista simple sino de una doblemente enlazada
/*----------------------------------------------------------------------------*/
/*
  pre : lista creada con crearLista().
...
/*
  pre : la lista fue creada con crearLista().
  post : devuelve los datos de la lista.
